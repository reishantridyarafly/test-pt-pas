                    ...
                    <form id="form">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="user_id" name="user_id"
                                value="{{ $customer->user_id }}" disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="status">
                                <option value="NEW CUSTOMER" {{ $customer->status === 'NEW CUSTOMER' ? 'selected' : '' }}>
                                    NEW CUSTOMER</option>
                                <option value="LOYAL CUSTOMER"
                                    {{ $customer->status === 'LOYAL CUSTOMER' ? 'selected' : '' }}>LOYAL CUSTOMER</option>
                            </select>
                        </div>
